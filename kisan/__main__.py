...
async def start_command(client, message: Message):
  await message.reply_photo(
                            ...
                            caption = f"ʜᴇʏ, ᴛʜɪs ɪs ᴀ sɪᴍᴘʟᴇ  ʙᴏᴛ ᴡʜɪᴄʜ ᴍᴀɴᴀɢᴇ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴘᴇʀғᴇᴄᴛʟʏ ᴀɴᴅ ᴘʀᴏᴛᴇᴄᴛs ʏᴏᴜʀ ɢʀᴏᴜᴘ ғʀᴏᴍ sᴏᴍᴇ ᴄʜᴜᴛɪʏᴀ's /ᴀᴅᴅ ᴍᴇ ɪɴ ɢʀᴏᴜᴘ ᴀɴᴅ ɢɪᴠᴇ ᴍᴇ ᴀʟʟ ᴀᴅᴍɪɴ ʀɪɢʜᴛs ᴀɴᴅ ᴛʜᴇɴ sᴇᴇ ᴍʏ ᴀʙɪʟɪᴛɪᴇs.",
